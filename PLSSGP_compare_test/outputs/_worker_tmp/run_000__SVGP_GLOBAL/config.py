...
PROJECT_CONFIG = {
    ...
    "suite": {
        ...
        "env_module": "envs/mountaincar_hold/env.py",  # fallback; suite_config.py prefers ENV_NAME mapping below
...
ENV_NAME = "mountaincar_hold"   # choices: "cartpole_swingup", "mountaincar_hold"
ENV_MODULE_BY_NAME = {
...
SUCCESS_HOLD_STEPS_BY_ENV = dict(_SUC.get("hold_steps_by_env", {"cartpole_swingup": 200, "mountaincar_hold": 200}))
