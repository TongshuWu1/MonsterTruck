# MountainCarContinuous goal-reaching environment module for the PLSSGP comparison suite.
#
...
try:
    ...
    print(f"⚠️ Task registry unavailable in envs/mountaincar/env.py ({_task_exc})")
...
print("✅ Env ready (MountainCarContinuous goal-reaching; no edge_respawn)")
print("obs:", obs)
